...
public class GameStages {
    ...
    public static void init() {
        newGameStage("Starting",20,3000,GameFlag.REVIVE,GameFlag.GRACE,GameFlag.FREEZE)
        ...
        newGameStage("Grace",60*40,3000,GameFlag.HASTE,GameFlag.REVIVE,GameFlag.GRACE)
        ...
        newGameStage("Shrink",60*30,100,GameFlag.SHRINK)
        ...
        newGameStage("Armageddon",60*3,2,GameFlag.SHRINK,GameFlag.COLLAPSE)
        ...
        newGameStage("Finale",2000000000,2,GameFlag.COLLAPSE)
